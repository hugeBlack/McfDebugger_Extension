...
import { McfRuntime, IMockBreakpoint, FileAccessor } from './mcfRuntime';
...
export class MockDebugSession extends LoggingDebugSession {
	...
	public constructor(fileAccessor: FileAccessor) {
		...
		this._runtime = new McfRuntime(fileAccessor);
	...
	protected exceptionInfoRequest(response: DebugProtocol.ExceptionInfoResponse, args: DebugProtocol.ExceptionInfoArguments) {
		response.body = {
			exceptionId: this._runtime._exceptionId,
			description: this._runtime._exceptionName,
			breakMode: 'always',
			details: {
				message: "",
				typeName: '',
				stackTrace: this._runtime._exceptionMsg,
	...
	protected stackTraceRequest(response: DebugProtocol.StackTraceResponse, args: DebugProtocol.StackTraceArguments): void {
		...
		const stk = this._runtime.stack(this._runtime._stackObj);
	...
	protected scopesRequest(response: DebugProtocol.ScopesResponse, args: DebugProtocol.ScopesArguments): void {
		...
		response.body = {
			scopes: [
				new Scope("CommandSource", this._variableHandles.create("CommandSource"),false),
			]
		};
		this.sendResponse(response);
	}
	...
	protected async variablesRequest(response: DebugProtocol.VariablesResponse, args: DebugProtocol.VariablesArguments, request?: DebugProtocol.Request) {
		...
		for(const key of Object.keys(this._runtime._variables)) {
			variables.push({
				name:key,
				value:this._runtime._variables[key],
